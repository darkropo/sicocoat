...
$this->Html->addCrumb('Grafica Parametros', '/muestreospts/graficadatospts');
$estaciones = NULL; ?>
<div class="form">
<?php echo $this->Form->create('MuestreosPt')?>
	<fieldset>
		<legend><?php echo __('Graficas PTS Días de muestreo X Concentración.'); ?></legend>
	<?php
		echo $this->Form->input('proyectos_id', array('id' => 'proyecto','empty' => true)); 
                echo $this->Form->input('elemento_id');
