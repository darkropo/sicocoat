...
<?php echo $this->Form->create('Ciclohasestacione'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ciclohasestacione'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Ciclohasestacione.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Ciclohasestacione.id'))); ?></li>
