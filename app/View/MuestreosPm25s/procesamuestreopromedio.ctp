...
$this->Html->addCrumb('Graficar Promedio', '/muestreospm25s/graficapromedio');
...
echo $this->Html->link('Grafica Promedio PM2.5', '/muestreospm25s/popuppromedio?grafpm25='.$grafpm25.'&estacion='.$estacion, 
