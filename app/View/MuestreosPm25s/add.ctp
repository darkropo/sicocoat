<?php //echo $this->element('listpm25'); ?>
<div class="muestreosPm25s form">
<?php 
$this->Html->addCrumb('Muestreos Pm 2.5', '/muestreospm25s');
$this->Html->addCrumb('Agregar Pm 2.5', '/muestreospm25s/add');
echo $this->Form->create('MuestreosPm25'); ?>
	<fieldset>
		<legend><?php echo __('Agregar Muestreos Pm25'); ?></legend>
<TABLE> 
   <TR> 
