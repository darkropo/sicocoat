...
//$sumxcuadrado = 0;
?>
<div class="grafica" style="height:550px;width:939px;">
    <H2>Promedios para el proyecto <?php echo $_GET['proyecto']; ?> en el Año <?php echo $_GET['anio']; ?></H2>
     <div id="procesapromediogeneral" style="height:550px; width:939px;" ></div>
</div>
