...
<!--                    <div class="mid-left">
    ...
    <?php             echo $this->Html->scriptBlock("$('.procesamuestreopromedio').popupWindow({ 
                                                windowName:'Grafico PM 2.5 Promedio',
                                                height:800, 
                                                width:975, 
                                                });");
                    ...
                    $(document).ready(function(){
                       ...
                       //var ticks = ['May', 'June', 'July', 'August'];
                         ...
                         var plot1 = $.jqplot('procesamuestreopromedio', [".$_GET['grafpm25']."], {
                            title:'Grafica Promedio PM 2.5',
